...
class MyConstants():
    ...
    STOP_SPAWNING_2P = 0.50         ## PERCENTAGE OF MAX TURNS WHEN TO STOP SPAWNING SHIPS
    STOP_SPAWNING_4P = 0.25         ## FOR 4 PLAYERS
    ...
    DONT_HARVEST_BELOW = 10         ## DONT HARVEST BELOW THIS NUMBER (USED TO BE 5 FOR V6 BELOW)
    ...
    MIN_DIST_BTW_DOCKS = 11         ## MINIMUM DISTANCE BETWEEN DOCKS/SHIPYARD (12 for V7)
