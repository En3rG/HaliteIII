...
class MyConstants():
    ...
    POTENTIALLY_ENOUGH_CARGO = 750                  ## MAYBE ENOUGH TO GO HOME
    DEPOSIT_HARVEST_CHECK_PERCENT = 1.50            ## ONLY TAKES PERCENTAGE OF HARVEST INTO ACCOUNT, BUT IF ITS OVER 1000 ALREADY, GO HOME
    ...
    HARVEST_ABOVE_PERCENTILE = 60                   ## USED TO BE:
                                                    ## V28: 35
