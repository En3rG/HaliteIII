...
class MyConstants():
    ...
    ALLOW_SPAWNING_2P_48_TURNS = 0.65
    ALLOW_SPAWNING_2P_56_TURNS = 0.65
    ALLOW_SPAWNING_2P_64_TURNS = 0.65
    ALLOW_SPAWNING_4P_32_TURNS = 0.55
    ALLOW_SPAWNING_4P_40_TURNS = 0.55
    ALLOW_SPAWNING_4P_48_TURNS = 0.55
    ALLOW_SPAWNING_4P_56_TURNS = 0.55
    ALLOW_SPAWNING_4P_64_TURNS = 0.55
