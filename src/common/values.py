...
class MyConstants():
    ...
    DOCK_MANHATTAN = 10                             ## MANHATTAN DISTANCE OF WHEN DOCK BUILD IS EXECUTED
                                                    ## USED TO BE:
                                                    ## V28: 2
    ...
    ATTACK_TURNS_LOWER_LIMIT = 0.30
                                                    ## USED TO BE:
                                                    ## V28: 0.80

    ## DEPOSIT
    DEPOSIT_SEARCH_PERIMETER = 5
    POTENTIALLY_ENOUGH_CARGO = 875                  ## MAYBE ENOUGH TO GO HOME
    DEPOSIT_HARVEST_CHECK_PERCENT = 0.70            ## ONLY TAKES PERCENTAGE OF HARVEST INTO ACCOUNT, BUT IF ITS OVER 1000 ALREADY, GO HOME
    ...
    ALLOW_SPAWNING_2P_48_TURNS = 0.69
    ALLOW_SPAWNING_2P_56_TURNS = 0.72
