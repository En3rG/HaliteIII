...
class MyConstants():
    ...
    STOP_SPAWNING_2P_32_TURNS_LEFT = 0.50
    STOP_SPAWNING_2P_40_TURNS_LEFT = 0.55
    STOP_SPAWNING_2P_48_TURNS_LEFT = 0.60
    STOP_SPAWNING_2P_56_TURNS_LEFT = 0.65
    STOP_SPAWNING_2P_64_TURNS_LEFT = 0.65
    STOP_SPAWNING_4P_32_TURNS_LEFT = 0.35
    STOP_SPAWNING_4P_40_TURNS_LEFT = 0.40
    STOP_SPAWNING_4P_48_TURNS_LEFT = 0.45
    STOP_SPAWNING_4P_56_TURNS_LEFT = 0.50
    STOP_SPAWNING_4P_64_TURNS_LEFT = 0.55
    ...
    ENABLE_TOP_HARVEST_TURNS_LEFT = 0.8
